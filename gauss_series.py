...
if __name__ == '__main__':
    ...
    fine_E_space = np.linspace(0, 4.0, 1000)
    ...
    colors = [DUNEblue, DUNEdarkOrange, DUNEgreen, DUNEyellow]
    gauss_peak_locs = [0.5, 1.0, 2.0, 3.0]
    ...
    fitter = flux_fitter("nu", "numu", "numu", "numu", Erebin = 1)
